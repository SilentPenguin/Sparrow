...
namespace Sparrow.Events
{
    ...
    public class EventPipeline : VariableRatePipeline
    {
        ...
        private static IEnumerable<Type> eventTypes = new List<Type>
        {
            ...
            typeof(ControllerButtonDownEvent),
            typeof(ControllerButtonUpEvent),
            typeof(ControllerDeviceAddedEvent),
            typeof(ControllerDeviceRemappedEvent),
            typeof(ControllerDeviceRemovedEvent),
            typeof(DollarGestureEvent),
            typeof(DollarRecordEvent),
            typeof(DropBeginEvent),
            typeof(DropCompleteEvent),
            typeof(DropFileEvent),
            typeof(DropTextEvent),
            typeof(JoystickAxisEvent),
            typeof(JoystickBallEvent),
            typeof(JoystickButtonDownEvent),
            typeof(JoystickButtonUpEvent),
            typeof(JoystickDeviceAddedEvent),
            typeof(JoystickDeviceRemovedEvent),
            typeof(JoystickHatEvent),
            typeof(KeyboardKeyDownEvent),
            typeof(KeyboardKeyUpEvent),
            typeof(MouseButtonDownEvent),
            typeof(MouseButtonUpEvent),
            ...
            typeof(TouchDownEvent),
            typeof(TouchMoveEvent),
            typeof(TouchUpEvent),
            typeof(UserEvent),
            typeof(WindowEvent),
        };
