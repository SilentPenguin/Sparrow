...
namespace Sparrow.Numerics
{
    public partial struct Matrix<T> where T : struct
    {
        ...
        {
            public abstract S Get(S[,] a, int x, int y);
            public abstract S[] GetColumn(S[,]a, int x);
        ...
        {
            public override float Get(float[,] a, int x, int y)
            {
                return a[x, y];
            }
        ...
        {
            public override double Get(double[,] a, int x, int y)
            {
                return a[x, y];
            }
